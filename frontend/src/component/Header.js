      ...
      <div className="flex item-center h-full justify-between">
        ...
        <div className="flex item-center gap-4 md:gap-7">
          ...
          <div className="text-2xl text-slate-600">
            <div className="absolute top-0 right-0 h-4 w-4  rounded-full m-0 p-0 text-sm  text-center"></div>
            <FaShoppingCart />
          </div>
          ...
          <div className="text-2xl text-slate-600" onClick={handleShowMenu}>
            ...
            {showMenu && (
              <div className="absolute right-2 bg-white py-2 px-2 shadow drop-shadow-md flex flex-col">
                <Link to={"NewProduct"} className="whitespace-nowrapp cursor-pointer">New Product</Link>
